...
class CollectionTests: XCTestCase {
    ...
    func testLoadCollection() {
        ...
        XCTAssert(!(collection.files.count < 4), "there are too few files in the collection")
        XCTAssert(!(collection.files.count > 4), "there are too many files in the collection")
    }
    ...
    func testAddToCollection() {
        ...
        XCTAssert(!(collection.files.count < 5), "there are too few files in the collection")
        XCTAssert(!(collection.files.count > 5), "there are too many files in the collection")
    }
    ...
    func testRemoveNonRequiredAndSearchCollection(){
        ...
        XCTAssert(!(collection.files.count < 1), "there are too few files in the collection")
        XCTAssert(!(collection.files.count > 1), "there are too many files in the collection")
        XCTAssert(collection.search(term: "code").count == 1, "Too many or too few entries")
